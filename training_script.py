...
image_size = 128  # training images from MS COCO are resized to image_size x image_size
batch_size = 1
...
training_config['style_img_name'] = 'greatwave.jpg'
training_config['content_weight'] = 1e0
training_config['style_weight'] = 4e5
training_config['tv_weight'] = 0
training_config['num_of_epochs'] = 2
training_config['subset_size'] = None
training_config['enable_tensorboard'] = True
training_config['image_log_freq'] = 100
training_config['console_log_freq'] = 500
training_config['checkpoint_freq'] = 2000
...
def run(stylename):
    training_config['style_img_name'] = stylename
    
    train(training_config)

    return model_binaries_path
